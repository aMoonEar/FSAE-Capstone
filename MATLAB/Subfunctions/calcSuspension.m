...
%   ___.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [innerDiameter] = calcSuspension(...
    FxFront,...
    FxRear,...
    FyFront,...
    FyRear,...
    ...
    [meanCoilDiameter, wireDiameter, innerDiameterSpring, fullSolidDeflection, springrate_N_per_mm] = SpringCalculation(...
        springRate,...
        frontpushrodforce);
    
    [damperwallThickness , innerHousingDiameterOfDamper, orificeDiameter, forceOnDamper] = DamperCalculation(...
        dampingCoefficientSuspension,...
        fullSolidDeflection,...
        innerDiameterSpring,...
        frontpushrodforce,...
        springrate_N_per_mm );
