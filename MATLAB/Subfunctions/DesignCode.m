...
function DesignCode(driverWeight, corneringRadius, suspensionFeel)
    ...
    [totalMass, lengthCOMToRearTire, lengthCOMToFrontTire, COMFromGroundX, COMFromGroundY, COMFromGroundZ, lengthCOMToFrontWing, lengthCOMToRearWing, heightCOMToFrontWing, heightCOMToRearWing, lengthToRightWheelCOM, lengthToLeftWheelCOM] = calcCenterOfMass(driverWeight);
    
    % Complete the modelling of the vehicle to determine important normal
    % forces
    [normalForceFrontWheel, normalForceRearWheel, normalForceFrontAcceleration, normalForceRearAcceleration, normalForceFrontStatic, normalForceRearStatic] = calcModeling(...
        totalMass,...
        lengthCOMToRearTire,...
